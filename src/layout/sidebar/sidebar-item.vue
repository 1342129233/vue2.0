<template>
  <div v-if="item.children && !item.hidden" class='lay-nav-left'>
    <template>
...
.lay-nav-left >>> .el-submenu__title
  color #ffffff
.lay-nav-left >>> .el-submenu__title:hover
  background var(--hsegreen)
.lay-nav-left >>> .el-submenu__title:focus
  background var(--hsegreen)
</style>
